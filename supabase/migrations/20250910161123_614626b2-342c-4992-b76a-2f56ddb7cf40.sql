-- Add missing columns and ensure proper structure for Basepay integration
...
-- Ensure webhook_events table has required structure
...
-- Update webhook_events structure to match expected format
ALTER TABLE webhook_events DROP COLUMN IF EXISTS gateway_name;
ALTER TABLE webhook_events DROP COLUMN IF EXISTS event_id;
ALTER TABLE webhook_events RENAME COLUMN payload TO payload;
